...
export default function SearchMovies(){
    ...
    function getMovie(e){
        e.preventDefault();
        try{
        fetch(`https://api.themoviedb.org/3/search/movie?api_key=6690ea3f7711f134017e08086400f699&language=en-US&query=${query}&page=1&include_adult=false`).then(res=> res.json())
        .then(data=>{
